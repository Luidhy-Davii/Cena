  ...
  return (
    ...
    >
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        {/* PLAYER — substitui o backdrop quando ativo */}
        {trailerKey ? (
        ...
        <div className="modal__inner">
          ...
          <div className="modal__info">
            <div className="modal__badges">
              <span className="modal__badge modal__badge--type">
                {isTV ? 'Série' : 'Filme'}
              </span>
              {item.adult && (
                <span className="modal__badge modal__badge--adult">+18</span>
              )}
            </div>
            ...
            <div className="modal__popularity">
              ...
              <div className="modal__popularity-bar">
                <div
                  className="modal__popularity-fill"
                  style={{ width: `${Math.min(item.popularity / 5, 100)}%` }}
                ></div>
              </div>
              <span className="modal__popularity-val">
    ...
    <>
      <section className="discover" id="descobrir">
        ...
        <div className="discover__content">
          ...
          {error && (
            <p className="discover__error" role="alert">
          ...
          {!loading && !error && data.length > 0 && (
            <>
              {featured && (
                <article
                  className="discover__featured"
                  aria-label={`Destaque: ${getTitle(featured)}`}
                >
                  ...
                  <div className="discover__featured-inner">
                    <div className="discover__featured-poster" aria-hidden="true">
                      <img
                        src={`${IMAGE_URL}/w500${featured.poster_path}`}
                        alt=""
                        loading="lazy"
                      />
                    </div>
                    ...
                    <div className="discover__featured-info">
                      <div className="discover__featured-badges">
                        <span className="discover__badge discover__badge--violet">
                          {isTV ? 'Série' : 'Filme'}
                        </span>
                        <span className="discover__badge discover__badge--outline">
                          #1 desta semana
                        </span>
                      </div>

                      <h3 className="discover__featured-title">
                        {getTitle(featured)}
                      </h3>
                      ...
                      <div className="discover__featured-meta">
                        ...
                        <span className="discover__meta-sep" aria-hidden="true"></span>
                        <span className="discover__meta-item">
                        ...
                        {featured.vote_count > 0 && (
                          <>
                            <span className="discover__meta-sep" aria-hidden="true"></span>
                            <span className="discover__meta-item">
                              {featured.vote_count.toLocaleString('pt-BR')} votos
                            </span>
                          </>
                        )}
                      </div>
                      ...
                      <div className="discover__featured-actions">
                        ...
                        <button className="discover__btn discover__btn--ghost">
                          ♡ Favoritar
                        </button>
                      </div>
                    </div>
